...
/**
 * Text which should be imprinted into main area
 * @param aText
 * @returns {mosyText}
 */
function mosyText(aText) {
  this.options.mosyText = aText;
  return this;
} // mosyText

/**
 * Text which need to be imprinted into speed area.
 *
 * @param aSpeed -
 * @returns {mosySpeed}
 */
function mosySpeed(aSpeed) {
  if(!aSpeed)
    return this;

  aSpeed = aSpeed.toString();

  this.options.mosySpeed = aSpeed.padStart(3," ");
  return this;
}
